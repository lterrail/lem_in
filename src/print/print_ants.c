...
/*   Updated: 2018/06/27 16:44:42 by lterrail         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char		*read_ants(char *room, char *soluc, int turn)
{
	...
	len = ft_count_char(&soluc[i], '-') + 1; //compte le nombre de soluc n + 1
	...
	room = ft_strcpy_char(room, &soluc[i], '-');
	return (room);
}
